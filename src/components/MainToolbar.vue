<template>
  <div class="toolbar">
    <!-- Home icon -->
    <svg @click="setActive('home')" :class="['icon', 'icon--home', 'toolbar__icon', { 'is-active': activeIcon === 'home' }]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- Chart icon -->
    <svg @click="setActive('chart')" :class="['icon', 'icon--chart', 'toolbar__icon', { 'is-active': activeIcon === 'chart' }]" width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- Smile icon -->
    <div @click="setActive('smile')" :class="['icon', 'icon--smile', 'toolbar__icon', { 'is-active': activeIcon === 'smile' }]">
      <svg :class="smileClass" width="20px" height="17.5px" viewBox="0 0 16 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <!-- Bell icon -->
    <svg @click="setActive('bell')" :class="['icon', 'icon--bell', 'toolbar__icon', { 'is-active': activeIcon === 'bell' }]" width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- Search icon -->
    <svg @click="setActive('search')" :class="['icon', 'icon--search', 'toolbar__icon', { 'is-active': activeIcon === 'search' }]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default defineComponent({
  ...
  setup() {
    ...
    const activeIcon = ref(currentPage.value || 'home')

    watch(() => route.name, (newName) => {
      if (newName) {
        activeIcon.value = newName as string
        currentPage.value = newName as string
      }
    })

    const smileClass = computed(() => {
      switch(activeIcon.value) {
        case 'home': return 'maj-left'
        case 'chart': return 'min-left'
        case 'bell': return 'min-right'
        case 'search': return 'maj-right'
        default: return ''
      }
    })
    ...
    const setActive = (icon: string) => {
      ...
      currentPage.value = icon
      const bgColor = icon === 'smile' ? 'blue' : icon
